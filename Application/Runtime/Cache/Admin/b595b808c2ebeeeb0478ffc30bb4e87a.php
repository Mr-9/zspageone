...
<link rel="stylesheet" type="text/css" href="/public/Public/Admin/css/jquery.dialog.css" />
<link rel="stylesheet" href="/public/Public/Admin/css/index.css" />
...
<div id="container">
  ...
  <div id="bd">
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="agency">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="<?php echo U('Dept/showList');?>">学员列表</a></li>
              <li><a href="javascript:;" date-src="<?php echo U('Dept/add');?>">添加学员</a></li>
            </ul>
          </li>
          <li class="email">
      ...
      <div class="content">
        <!-- <iframe src="/public/index.php/Admin/Index/home" id="iframe" width="100%" height="100%" frameborder="0"></iframe> -->
...
<script type="text/javascript" src="/public/Public/Admin/js/core.js"></script>
<script type="text/javascript" src="/public/Public/Admin/js/jquery.dialog.js"></script>
<script type="text/javascript" src="/public/Public/Admin/js/index.js"></script>
</html>